...
public class DailyTomato {
    ...
    public enum Stage {
        ...
        PLANT(50, 74, R.string.toma_stage_grow, R.drawable.ic_toma_plant),
        FLOWER(75, 99, R.string.toma_stage_flower, R.drawable.ic_toma_flower),
        RIPE(100, Integer.MAX_VALUE, R.string.toma_stage_ripe, R.drawable.ic_toma_ripe);
